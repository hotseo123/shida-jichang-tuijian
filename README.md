...
整理这份清单，是我自己长期使用和测试机场的经验总结。里面记录的都是真正长期稳定、实际可用的机场，里面大部分机场我都使用过，不靠营销噱头，也不刷榜单。十个机场也刚刚维护的过来，再多就顾不过来，我会持续关注更新机场的状态，每周更新一次，把新的好机场加进去，把已经不行的标注出来。目的是帮大家少踩坑，用的时候不至于天天翻论坛找替代。
